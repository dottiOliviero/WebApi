...
you should see from your console that the application is running on http://127.0.0.1:5000.

Open a browser and type http://127.0.0.1:5000, it should appear a blank page which says "welcome to the rates converter"
